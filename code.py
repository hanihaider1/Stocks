...
class Stocks:
    ...
    def stock(self):
        ...
        summary = {'summary': ["SQ", "PYPL"],'Highest High': [max_value["Close"],max_value1["Close"]],
        'Lowest Low': [min_value["Close"],min_value1["Close"]],'Percentage Change': [percentage["Largest percent"],percentage1["Largest percent"]]}
